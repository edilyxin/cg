...
public class EpProjectDAO extends SqlMapClientDaoSupport {
    ...
    public List find(EpPackageForm record) {
       return getSqlMapClientTemplate().queryForList("EP_PROJECT_select", record);
    }
    ...
    public List findByPage(EpProjectForm record){
    	return getSqlMapClientTemplate().queryForList("EP_PROJECT_findByPage", record);
    }
    
    public int findBySize(EpProjectForm record){
    	return (Integer)getSqlMapClientTemplate().queryForObject("EP_PROJECT_findBySize", record);
    }
    
    public List findByForm(EpProjectForm record){
    	return getSqlMapClientTemplate().queryForList("EP_PROJECT_select", record);
    }
