...
public class EpEntrancecDAO extends SqlMapClientDaoSupport {
    ...
    public EpEntrancec selectByEPD_NID(BigDecimal EPD_NID) {
        EpEntrancecForm key = new EpEntrancecForm();
        key.setEPD_NID(EPD_NID);
        EpEntrancec record = (EpEntrancec) getSqlMapClientTemplate().queryForObject("EP_ENTRANCEC_selectByEPD_NID", key);
        return record;
    }
