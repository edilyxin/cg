 ...
 * 
 *  @Project       : BeiGS
 *  @Program Name  : com.rc.declare.vo.AsAccessory.java
 *  @Class Name    : AsAccessory
 *  @Description   : 附件表
 *  @Author        : Administrator
 *  @Creation Date : 2013-10-7下午04:47:30
 */
public class AsAccessory {
	...
	private Date as_dtime;//	上传时间	datetime
	...
	private Date as_sreplydate;//	填写日期	datetime
	private String as_salterby;//	修改人	varchar
	private Date as_salterdate;//	修改日期	datetime
