 ...
 * 
 *  @Project       : BeiGS
 *  @Program Name  : com.rc.declare.vo.DMFDivMoneyF.java
 *  @Class Name    : DMFDivMoneyF
 *  @Description   : 金额分配子表
 *  @Author        : Administrator
 *  @Creation Date : 2013-10-7下午04:47:30
 */
public class DMFDivMoneyF {
	...
	private Date dmf_dreplydate;//	分配时间	datetime
	private String dmf_salterby;//	修改人	varchar
	private Date dmf_dalterdate;//	修改时间	datetime
	...
	private Date dmf_ddef1;//		datetime
	private Date dmf_ddef2;//		datetime
	private Date dmf_ddef3;//		datetime
	private Date dmf_ddef4;//		datetime
	private Date dmf_ddef5;//		datetime
	...
	public Date getDmf_dreplydate() {
		return dmf_dreplydate;
	}
	public void setDmf_dreplydate(Date dmf_dreplydate) {
	...
	public Date getDmf_dalterdate() {
		return dmf_dalterdate;
	}
	public void setDmf_dalterdate(Date dmf_dalterdate) {
	...
	public Date getDmf_ddef1() {
		return dmf_ddef1;
	}
	public void setDmf_ddef1(Date dmf_ddef1) {
		this.dmf_ddef1 = dmf_ddef1;
	}
	public Date getDmf_ddef2() {
		return dmf_ddef2;
	}
	public void setDmf_ddef2(Date dmf_ddef2) {
		this.dmf_ddef2 = dmf_ddef2;
	}
	public Date getDmf_ddef3() {
		return dmf_ddef3;
	}
	public void setDmf_ddef3(Date dmf_ddef3) {
		this.dmf_ddef3 = dmf_ddef3;
	}
	public Date getDmf_ddef4() {
		return dmf_ddef4;
	}
	public void setDmf_ddef4(Date dmf_ddef4) {
		this.dmf_ddef4 = dmf_ddef4;
	}
	public Date getDmf_ddef5() {
		return dmf_ddef5;
	}
	public void setDmf_ddef5(Date dmf_ddef5) {
