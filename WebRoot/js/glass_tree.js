...
function WebFXTreeItem(sText, url,listname,switchs) {
	this._subItems  = [];
	this._wasLast   = false;
	this.text       = sText || defaultText;
//	this.action     = sAction || defaultAction;
...
//		str += "<onclick=\"treeitem_Click('" + this.id +  "','" + this.text + "','" + this.treeID + "','" + this.nodeId + "');\" onDblClick=\"change(this);\" id=\"" + this.id + "-anchor\" onfocus=\"webFXTreeHandler.focus(this);\" title=\""+this.text+"\">" + this.text;
		 str += "<a href=\"javascript:void(0);\" ondblclick=\"returnVal('"+this.url+"','"+this.listname+"','"+this.switchs+"')\"  id=\"" + this.id + "-anchor\" onfocus=\"webFXTreeHandler.focus(this);\" title=\""+this.text+"\">" + this.text + "</a>"; 
