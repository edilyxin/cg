...
Function.prototype.bindAsEventListener=function(object){
	var __method=this;return function(event){__method.call(object,event||window.event);};};
...
build:function(){
	...
	var path = "http://www.fdc.zju.edu.cn/zjufc/js/";
	//关闭按钮
	...
	//var close = '<input type="image" id="dialogBoxClose" src="../js/dialogclose.gif" border="0" width="16" height="16" align="absmiddle" title="关闭"/>';
...
reBuild:function(){G('dialogBody').height=G('dialogBody').clientHeight;this.lastBuild();},
