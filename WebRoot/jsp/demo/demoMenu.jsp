...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td nowrap valign="top" align="left"><!--菜单树开始--> 
							 ...
							 {
								var node0=new WebFXTree("<b>项目1</b>","<%=path%>/demo!find","searchB=|menu=0");
								var node1=new WebFXTree("<b>项目2</b>","<%=path%>/demo!find","searchC=|menu=0");
								node0.add(node1);
	...
	<tr>
		<td><a href="<%=path%>/demo!find">tttttt</a></td>
	</tr>
</table>
