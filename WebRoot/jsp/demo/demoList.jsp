...
<!--       <tr> -->
<!--       	<td height="20"  ><input type="checkbox" name="idcheckbox" onclick="checkOne();"  value="" /></td> -->
<%--         <td height="20"   >${from.field1}</td> --%>
<%--         <td height="20"   >${from.field2}</td> --%>
<%--         <td height="20"   >${from.field3}</td> --%>
<%--         <td height="20"   >${from.field1}</td> --%>
<%--         <td height="20"  >${from.field2}</td> --%>
<%--         <td height="20"   >${from.field3}</td> --%>
<%--         <td height="20"   >${from.field1}</td> --%>
...
<!--       </tr> -->
      ...
      <tr bgcolor="#FFFFFF" <s:if test="#li.field1==\"1\"">style="color:red;"</s:if>>
        ...
        <td height="20"   title="${li.field1}">${li.field1}</td>
        <td height="20"  title="${li.field1}">${li.field1}</td>
        <td height="20"   title="${li.demo1Form.field1}">${li.demo1Form.field1}</td>
        <td height="20"   title="${li.demo1Form.field1}">${li.demo1Form.field1}</td>
        <td height="20"   title="${li.demo1Form.field1}">${li.demo1Form.field1}</td>
        <td height="20"  >
           11        
