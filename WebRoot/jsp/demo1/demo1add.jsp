...
function save(){
		...
		if(validator()){
		if(confirm("是否保存？")){
			document.form1.action="<%=path%>/demo1!add";
        					...
        					<td   bgcolor="#FFFFFF">
					  			<table border="0" cellpadding="2" cellspacing="1" style="width:100%;height:100%;font-size:12px;font-family: Verdana, Arial, Helvetica, sans-serif;"  bgcolor="#E3E9EE">
					 				<tr>
					    				...
					    				<td nowrap width="55%">
					    					<input name="form.field1" id="post_sname" value="" 
					    					class="text" style="width:154px" maxlength="20" valid="required" errmsg="职称名称不能为空!"/>
