...
//Ajax验证字典项名称的唯一性
	...
	$.ajax({	
		type:'post',
		data:'form1.searchA='+level+"&form1.dict_sno="+dictnNo,
		dataType:'json',
 ...
 //验证字典项值的唯一性
	...
	$.ajax({	
		type:'post',
		data:'form1.searchB='+level+"&form1.dict_sno="+dictnNo,
		dataType:'json',
		async:false,//定义同步，或者异步方式
		url:'dict!findDictUniqueItem',
		success:function(data){
...
<body>
<form name="form1" id="daichao" action="dict!addItem" method="post">
 <div class="bigBox" >
		<!--外部大DIV，可以调整宽度-->
		<h2>
            							...
            							<td>
            								<table width="100%" border="0" cellspacing="0" cellpadding="0">
              									<tr>
                									...
                									<td width="94%" valign="bottom"><span class="STYLE1">添加字典项</span></td>
              									</tr>
            								</table>
            							</td>
 			...
 			<tr valign="top">
    			<td>
    				<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" >
					    ...
					    <td colspan="3">
						    <input name="form1.dict_sname" id="dict_sname" value="${vo.dict_sname}" readonly="readonly" class="text" style="width:154px;background: white;" maxlength="10" valid="required" errmsg="字典名称不能为空!"/>
						    <input name="form1.dict_sno" id="dict_sno" value="${vo.dict_sno}"   type="hidden" style="width:154px" maxlength="10"/>
					    ...
					    <td colspan="3">
						    <input name="form1.ditem_sname" id="ditem_sname" value=""  class="text" style="width:154px"
						    url="dict!findDictUniqueItem?form1.dict_sno=${vo.dict_sno}" urlmsg="字典项已存在！" 
						     maxlength="50" valid="required" errmsg="字典项不能为空!"/>
						    <span style="color:red;">*</span>&nbsp;&nbsp; 
					     </td>
					   </tr>
					    <tr>
					    ...
					    <td colspan="3">
						    <input name="form1.ditem_svalue" id="ditem_svalue" value=""   class="text" style="width:154px" 
						    url="dict!findDictUniqueItem?form1.dict_sno=${vo.dict_sno}" urlmsg="字典项值已存在！" 
					    ...
					    <td colspan="3" >
						    <input name="form1.ditem_sdef1" style="width:260px" id="ditem_sdef1" value="${form1.ditem_sdef1}"   class="text" maxlength="100" />
