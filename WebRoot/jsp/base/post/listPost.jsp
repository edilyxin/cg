...
<script>
  ...
  document.form1.action="<%=path%>/post!find";
  document.all.form1.submit();
}
  //新增
  function toAdd(){
	document.form1.action="<%=path%>/post!toAdd";
 ...
 if(document.form1.idcheckbox==null){
	 ...
	 if(confirm("是否修改？"))
	 {
		document.form1.action="<%=path%>/post!toUpdate";
		document.form1.submit();
	 }	
  }
 ...
 if(document.form1.idcheckbox==null){
	 ...
	 if(confirm("是否删除所选记录？"))
	 {
		document.form1.action="<%=path%>/post!toDelete";
		document.form1.submit();
	 }
  }
  //启用
 ...
 if(document.form1.idcheckbox==null){
	 ...
	 {
		document.form1.action="<%=path%>/post!changeValid";
		document.form1.submit();
	 }
  }  
...
<form name="form1" method="post" action="<%=path %>/post!find">
<div class="bigBox" id="idwidth">
    ...
    <div id="divwidth"  style="overflow:auto;overflow-y:hidden;">
   	<table width="1500px"  id="table1"  class="table"   border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
        ...
        <th width="120px" height="24" class="STYLE6"><div align="center"><span class="STYLE10">职称编号</span></div></th>
        <th width="160px" height="24" class="STYLE6"><div align="center"><span class="STYLE10">职称名称</span></div></th>
        <th width="160px" height="24" class="STYLE6"><div align="center"><span class="STYLE10">职称等级</span></div></th>
        <th width="160px" height="24" class="STYLE6"><div align="center"><span class="STYLE10">住宅面积数(m²)</span></div></th> 
        <th width="160px" height="24" class="STYLE6"><div align="center"><span class="STYLE10">办公面积数(m²)</span></div></th>
        <th width="160px" height="24" class="STYLE6"><div align="center"><span class="STYLE10">房补金额数(元/m²)</span></div></th>
        <th width="160px" height="24" class="STYLE6"><div align="center"><span class="STYLE10">供暖补贴费(元/m²)</span></div></th>
      ...
      <tr bgcolor="#FFFFFF" <s:if test="#li.post_sisvalid==\"1\"">style="color:red;"</s:if>>
        <td height="20" ><div align="center">
          <input type="checkbox" name="idcheckbox" onclick="checkOne();"  value="${li.post_sno}" />
          <input type="hidden" id="post_sisvalid" name="post_sisvalid" value="${li.post_sisvalid}"/>
        </div></td>
        <td height="20"  >${st.index+1}</td>
        <td height="20"   title="${li.post_sno}">${li.post_sno}</td>
        <td height="20"   title="${li.post_sname}">${li.post_sname}</td>
        <td height="20"   title="${li.post_nlevel}">${li.post_nlevel}</td>
        <td height="20"   title="${li.post_nresarea}">${li.post_nresarea}</td>
        <td height="20"  title="${li.post_nresarea}">${li.post_noffarea}</td>
        <td height="20"   title="${li.post_nhousmoney}">${li.post_nhousmoney}</td>
        <td height="20"   title="${li.post_nheatmoney}">${li.post_nheatmoney}</td>
        <td height="20"   title="${li.post_sdef1}">${li.post_sdef1}</td>
        <td height="20"  >
