...
//			alert("校区名称已存在，请重新输入！");
	...
	if(validator(document.form1)){
		document.form1.action="<%=path%>/school!add";
...
<input type="hidden" name="form.sh_sreplyby" value="admin"/>
<div class="bigBox" >
		<!--外部大DIV，可以调整宽度-->
		<h2>
            							...
            							<td>
            								<table width="100%" border="0" cellspacing="0" cellpadding="0">
              									<tr>
                									...
                									<td width="94%" valign="bottom"><span class="STYLE1">添加校区信息</span></td>
              									</tr>
            								</table>
            							</td>
					  			...
					  			<table border="0" cellpadding="2" cellspacing="1" style="width:100%;height:100%;font-size:12px;font-family: Verdana, Arial, Helvetica, sans-serif;"  bgcolor="#E3E9EE">
					 				<tr>
					    				...
					    				<td>
					    					...
					    					<input name="form.sh_sname" id="sh_sname" 
					    					url="<%=path%>/school!checkUnique"  urlmsg="校区名称已存在！" 
					    					value=""  class="text" style="width:154px" maxlength="50" valid="required" errmsg="校区名称不能为空!"/>
					    			...
					    			<tr>
					    				...
					    				<td >
					    					<span style="white-space:nowrap;" >
					    					<input name="form.sh_ssname" id="sh_ssname" value=""  class="text" style="width:154px" maxlength="25" valid="required" errmsg="校区简称不能为空!"/>
					  				...
					  				<tr>
					    				...
					    				<td >
					    					<input type="text" name="form.sh_narea" id="sh_narea" class="text" maxlength="10" style="width:154px" valid="isNumber" errmsg="校区占地面积只能是数字！" onkeyup="if(this.value.search(/^\d*(?:\.\d{0,2})?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/>
					    			㎡</td>
						     		</tr>
						     		<tr>
					    				...
					    				<td >
					    				<span style="white-space:nowrap;" >
					    				<input type="text" name="form.sh_sadder" id="sh_sadder" class="text" maxlength="100" style="width:254px" valid="required" errmsg="校区地址不能为空!"/>
					    				<span style="color:red;">*</span>&nbsp;&nbsp; 
					    				</span>
					    				</td>
					  				</tr>
						     		<tr>
					    				...
					    				<td>
					    					<input type="radio" name="form.sh_sisuse" id="sh_sisuse1" class="text" value="0" checked="checked"/>可用
					    					<input type="radio" name="form.sh_sisuse" id="sh_sisuse2" class="text" value="1"/>不可用
					     				</td>
					  				</tr>
					    			<tr>
					    				<td nowrap align="right" width="13%">土地编号:</td>
					    				<td>
					    					<input name="form.td_sno" id="td_sno" value=""  class="text" style="width:154px" valid="limit" max="25" errmsg="土地编号长度不能超过25字符!" />
					     				</td>
					  				</tr>
									</table>
							</td>
