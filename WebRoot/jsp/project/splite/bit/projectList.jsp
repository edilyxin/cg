...
<div class="bigBox" id="idwidth">
		...
		<div class="content">
            ...
            <!-- 根据配置添加功能按钮 -->
					...
					<a title="新增其他" href="<%=path%>/demo1!toAdd">
    ...
    <div id="divwidth"  style="overflow:auto;overflow-y:hidden;">
     ...
     <s:iterator value="list"  id="li" status="st"> 
      <tr bgcolor="#FFFFFF" <s:if test="#li.field1==\"1\"">style="color:red;"</s:if>>
        ...
        <td height="20"   title="${li.field1}"><a href="">修改</a></td>
        <td height="20"   title="${li.field1}">${li.field1}</td>
        <td height="20"   title="${li.field1}">${li.field1}</td>
        <td height="20"   title="${li.field1}">${li.field1}</td>
        <td height="20"  title="${li.field1}">${li.field1}</td>
        <td height="20"   title="${li.field1}">${li.field1}</td>
...
<!-- 分页标签END -->
		...
		<a href="<%=path%>/splite!splitPackage">将所选设备分成一包</a><br />
		<a href="<%=path%>/declarep!toAdd">填写查看进出口申报</a><br />
		<a href="<%=path%>/splite!toUpdateparameter">填写查看技术参数</a><br />
		<a href="<%=path%>/splite!submitPackage">提交分包</a><br />
		<a href="<%=path%>/splite!deletePackage">删除分包</a><br />
</form>
</body>
</html>
