...
<script>
  ...
  document.form1.action="<%=path%>/setting!list";
...
<div class="bigBox" id="idwidth">
    ...
    <div id="divwidth"  style="overflow:auto;overflow-y:hidden;">
   	<table width="1500px"  id="table1"  class="table"   border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
        ...
        <th width="120px" height="24" class="STYLE6"><div align="center"><span class="STYLE10">采购方式</span></div></th>
        <th width="40px" height="24" class="STYLE6"><div align="center"><span class="STYLE10">流程序号 </span></div></th>
        <th width="160px" height="24" class="STYLE6"><div align="center"><span class="STYLE10">工作名称</span></div></th>
        <th width="40px" height="24" class="STYLE6"><div align="center"><span class="STYLE10">工作日</span></div></th> 
        <th width="160px" height="24" class="STYLE6"><div align="center"><span class="STYLE10">操作页面</span></div></th>
        <th width="80px" height="24" class="STYLE6"><div align="center"><span class="STYLE10">操作人类型</span></div></th>
...
<!-- 分页标签END -->
   		...
   		<a href="<%=path%>/approve!toUpdate">修改</a>
		</div>
</form>
</body>
</html>
