				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr bgcolor="#D5EAFB">
						...
						<td><select><option>2012</option>
								<option>2013</option>
								<option>2013</option></select></td>
						<td colspan="2"><input type="button" id="" name="" value="查询项目汇总信息" /></td>
					</tr>
					<tr bgcolor="#0E6BB1">
						<td colspan="5"><span class="STYLE1" style="white-space: nowrap;">项目批复信息汇总信息列表</span></td>
						<td><a href="#"><span class="STYLE1">批复模板下载</span></a></td>
						<td><a title="导入批复信息" href="javascript:void(0);" onclick="importData()"><span class="STYLE1">导入批复信息</span></a></td>
