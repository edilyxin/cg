								...
								<tr bgcolor="#FFFFFF">
									<td bgcolor="#FFFFFF" align="center">
										<table border="0" cellpadding="2" cellspacing="1"
											...
											bgcolor="#E3E9EE">
											<tr>
												<td width="70px" heigth="40px">中标单位：</td>
												<td><input value="${vo.AG_NID}" type=text width="98%" /></td>
											</tr>
											<tr>
												<td width="70px" heigth="40px">中标时间：</td>
												<td><input value="<s:date format="yyyy-MM-dd" name="vo.EBW_TTIME" />" type=text style="width: 120px" onfocus="WdatePicker({maxDate:'%y-%M-{%d}'})"  class="Wdate" /></td>
											</tr>
											<tr>
												<td width="70px" heigth="40px">中标金额：</td>
												<td><input value="${vo.EBW_NMONEY}" type=text style="width: 95%" /></td>
											</tr>
											<tr>
												<td width="70px" heigth="40px">联系人：</td>
												<td><input value="${vo.EBW_SMAN}" type=text style="width: 95%" /></td>
											</tr>
											<tr>
												<td width="70px" heigth="40px">联系电话：</td>
												<td><input value="${vo.EBW_STELE}" type=text style="width: 95%" /></td>
											</tr>
											<tr>
												<td width="70px" heigth="40px">邮箱：</td>
												<td><input value="${vo.EBW_SMAIL}" type=text style="width: 95%" /></td>
											</tr>
											<tr>
												<td width="70px" heigth="40px">公示标题：</td>
												<td><input value="${vo.EBW_STITLE}" type=text style="width: 95%" /></td>
											</tr>
											<tr>
												<td width="70px" heigth="40px">公示内容：</td>
												<td><textarea type="" style="width: 95%" rows="4" value="${vo.EBW_SCONTENT}"></textarea></td>
											</tr>
											<tr>
												<td width="70px" heigth="40px">公示时间：</td>
												<td><input type=text value="<s:date format="yyyy-MM-dd" name="vo.EBW_TBEGIN"/>"  class="Wdate" />&nbsp;&nbsp;至&nbsp;&nbsp;<input
													type=text value="<s:date format="yyyy-MM-dd" name="vo.EBW_TEND"/>"  class="Wdate" /></td>
											</tr>
											<tr>
												<td width="70px" heigth="40px">附件：</td>
												<td><input value="${vo.EBW_SFILENAME}" type=file style="width: 95%" /></td>
											</tr>
										</table>
									</td>
								</tr>
